...
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h4 class="page-title">Edit Food Type</h4>
        </div>
        ...
        <div class="col-12">
            <div class="box">
                <div class="box-body">
                    ...
                    <form class="custom-validation" action="{{ route('foodTypeList.update',$menuLists->id) }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="fw-700 fs-16 form-label">Food Type Name</label>
                                        <input type="text" name="category_name" value="{{ $menuLists->category_name }}" class="form-control" placeholder="Food Type Name">
                                    </div>
                                </div>
                            </div>
                            <!--/row-->
                        ...
                        <table id="productorder" class="table table-hover no-wrap product-order" data-page-size="10">
                           ...
                           <tr>
                            ...
                            <td >
                                ...
                                <a href="{{ route('foodTypeList.edit',$menuLists->id) }}" class="text-info me-10" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                    ...
                                    <form id="delete-form-{{ $menuLists->id }}" action="{{ route('foodTypeList.destroy',$menuLists->id) }}" method="POST" style="display: none;">
                                        @method('DELETE')
                                                                                          @csrf
...
<script>
    ...
    $(document).on('change', '.priorityStatus', function () {
        ...
        $.ajax({
        url: "{{ route('foodTypePriorityStatusUpdate') }}",
        method: 'get',
    ...
    //end priority status code
        ...
        $(document).on('change', '.changeStatus', function () {
            ...
            var id =   $(this).find(':selected').data('id')
                ...
                $.ajax({
            url: "{{ route('foodTypeStatusUpdate') }}",
            method: 'get',
