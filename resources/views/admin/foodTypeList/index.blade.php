...
@section('body')
  ...
  <div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h4 class="page-title">Add/Edit Food Type</h4>
        </div>
        ...
        <div class="col-12">
            <div class="box">
                <div class="box-body">
                    ...
                    <form class="custom-validation" action="{{ route('foodTypeList.store') }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="category_name" class="form-control" placeholder="Food Type Name">
                                    </div>
                                </div>
                            </div>
