                ...
                <div class="box-body">
                    <div class="d-md-flex justify-content-between align-items-center">
                        <div class="d-flex justify-content-start align-items-center mb-20 mb-md-0">
                            ...
                            <div class="text-start">
                                <img src="{{ asset('/') }}public/admin/assets/images/food/biryanis.jpg" class="rounded10 w-80 mx-15" alt=""/>
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-md-end align-items-center">
                            <div class="text-end mx-15">
                                <span class="fs-50 text-success icon-Chart-line"><span class="path1"></span><span
                    ...
                    <div class="d-md-flex justify-content-between align-items-center">
                        <div class="d-flex justify-content-start align-items-center mb-20 mb-md-0">
                            ...
                            <div class="text-start">
                                <img src="{{ asset('/') }}public/admin/assets/images/food/burgers.jpg" class="rounded10 w-80 mx-15" alt=""/>
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-md-end align-items-center">
                            <div class="text-end mx-15">
                                <span class="fs-50 text-primary icon-Chart-line1"><span
                    ...
                    <div class="d-md-flex justify-content-between align-items-center">
                        <div class="d-flex justify-content-start align-items-center mb-20 mb-md-0">
                            ...
                            <div class="text-start">
                                <img src="{{ asset('/') }}public/admin/assets/images/food/dals.jpg" class="rounded10 w-80 mx-15" alt=""/>
                            </div>
                            <div>
                    ...
                    <div class="d-md-flex justify-content-between align-items-center">
                        <div class="d-flex justify-content-start align-items-center mb-20 mb-md-0">
                            ...
                            <div class="text-start">
                                <img src="{{ asset('/') }}public/admin/assets/images/food/noodles.jpg" class="rounded10 w-80 mx-15" alt=""/>
                            </div>
                            <div>
                    ...
                    <div class="d-md-flex justify-content-between align-items-center">
                        <div class="d-flex justify-content-start align-items-center mb-20 mb-md-0">
                            ...
                            <div class="text-start">
                                <img src="{{ asset('/') }}public/admin/assets/images/food/main.jpg" class="rounded10 w-80 mx-15" alt=""/>
                            </div>
                            <div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="review-tx">
                                        <div class="d-flex mb-10">
                                            <img src="{{ asset('/') }}public/admin/assets/images/avatar/1.jpg"
                                                 class="w-40 h-40 me-10 rounded100" alt=""/>
                                            <div>
                                                <p class="mb-0">Johen Doe</p>
                                                <p class="mb-0"><small class="text-mute">1 day ago</small>
                                                </p>
                                            </div>
                                        </div>
                                        <p class="mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing
                                    ...
                                    <img src="{{ asset('/') }}public/admin/assets/images/food/dish-1.png" class="dish-img" alt=""/>
                                </div>
                            </div>
                        </div>
                        <div class="box p-0">
                            <div class="box-body">
                                <div class="d-flex align-items-center">
                                    <div class="review-tx">
                                        <div class="d-flex mb-10">
                                            <img src="{{ asset('/') }}public/admin/assets/images/avatar/2.jpg"
                                                 class="w-40 h-40 me-10 rounded100" alt=""/>
                                            <div>
                                                <p class="mb-0">Mical Doe</p>
                                                <p class="mb-0"><small class="text-mute">2 day ago</small>
                                                </p>
                                            </div>
                                        </div>
                                        <p class="mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing
                                    ...
                                    <img src="{{ asset('/') }}public/admin/assets/images/food/dish-2.png" class="dish-img" alt=""/>
                                </div>
                            </div>
                        </div>
                        <div class="box p-0">
                            <div class="box-body">
                                <div class="d-flex align-items-center">
                                    <div class="review-tx">
                                        <div class="d-flex mb-10">
                                            <img src="{{ asset('/') }}public/admin/assets/images/avatar/3.jpg"
                                                 class="w-40 h-40 me-10 rounded100" alt=""/>
                                            <div>
                                                <p class="mb-0">Stepni Doe</p>
                                                <p class="mb-0"><small class="text-mute">3 day ago</small>
                                                </p>
                                            </div>
                                        </div>
                                        <p class="mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing
                                    ...
                                    <img src="{{ asset('/') }}public/admin/assets/images/food/dish-3.png" class="dish-img" alt=""/>
                                </div>
                            </div>
                        </div>
                        <div class="box p-0">
                            <div class="box-body">
                                <div class="d-flex align-items-center">
                                    <div class="review-tx">
                                        <div class="d-flex mb-10">
                                            <img src="{{ asset('/') }}public/admin/assets/images/avatar/4.jpg"
                                                 class="w-40 h-40 me-10 rounded100" alt=""/>
                                            <div>
                                                <p class="mb-0">Rehan Doe</p>
                                                <p class="mb-0"><small class="text-mute">4 day ago</small>
                                                </p>
                                            </div>
                                        </div>
                                        <p class="mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing
                                    ...
                                    <img src="{{ asset('/') }}public/admin/assets/images/food/dish-4.png" class="dish-img" alt=""/>
                                </div>
                            </div>
                        </div>
                        <div class="box p-0">
                            <div class="box-body">
                                <div class="d-flex align-items-center">
                                    <div class="review-tx">
                                        <div class="d-flex mb-10">
                                            <img src="{{ asset('/') }}public/admin/assets/images/avatar/5.jpg"
                                                 class="w-40 h-40 me-10 rounded100" alt=""/>
                                            <div>
                                    ...
                                    <img src="{{ asset('/') }}public/admin/assets/images/food/dish-5.png" class="dish-img" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
