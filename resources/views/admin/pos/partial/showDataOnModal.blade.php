        ...
        <div class="modal-pos-product-info">
            ...
            <div class="d-flex mt-10 mb-3">
                ...
                <a href="#" id="btn-minus{{ $productLists->id }}" class="btn btn-secondary btn-minus" data-type="minus" data-field="quant[2]"><i class="fa fa-minus"></i></a>
                    ...
                    <span class="input-group-btn">
                <input type="text" value="1" min="1" max="100"  name="quant[2]" id="quantityResultOneAjax{{ $productLists->id }}" class="quantityResult form-control w-50px fw-bold mx-2 text-center"
                       value="1">
                    </span>
...
@endif
            ...
            <input type="hidden" id="finalAmountForDataBaseOneAjax{{ $productLists->id}}" />
            <h2>Total Amount: <span class="text-success text-bold"  id="finalTotalAmountOneAjax{{ $productLists->id}}">{{ $productLists->default_price }} Taka</span></h2>
            <div class="row mt-20">
                <div class="col-4">
...
@include('admin.pos.partial.modalscript')
