                                    ...
                                    <div class="card tag-bx">
                                        <div class="card-header d-block border-0">
                                            ...
                                            <ul class="d-flex align-items-center flex-wrap">
                                                ...
                                                <li><a href="javascript:void(0);"
                                                       class="btn btn-outline-light btn-rounded me-2">Beverage</a></li>
                                                <li><a href="javascript:void(0);"
                                                       class="btn btn-outline-light btn-rounded me-2">Chicken</a></li>
                                                <li><a href="javascript:void(0);"
                                                            ...
                                                            <div class="card-body pb-2 pt-3">
                                                                <div class="text-center pop-cousin">
                                                                    <img src="assets/images/popular-img/pic-1.jpg"
                                                                         alt="">
                                                                    <a href="javascript:void(0);"><h6>Fish Burger</h6>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <li>
                            ...
                            <div class="dropdown header-profile2 ">
                                <a class="nav-link " href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <div class="header-info2 d-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center sidebar-info">
                                            <div>
                                                <h6 class="font-w500 mb-0 ms-2">{{ Auth::guard('admin')->user()->admin_name }}</h6>
                                            </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{ route('basicInformationEdit') }}" class="dropdown-item ai-icon ">
                                    ...
                                    <a href="{{ route('passwordEdit') }}" class="dropdown-item ai-icon ">
                                    ...
                                    <a href="{{ route('admin.logout.submit') }}" class="dropdown-item ai-icon ms-1"  onclick="event.preventDefault();
