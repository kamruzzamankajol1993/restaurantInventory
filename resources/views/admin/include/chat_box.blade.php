            ...
            <div class="chat-logs">
                <div class="chat-msg user">
                    <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img src="{{ asset('/') }}public/admin/assets/images/avatar/2.jpg" class="avatar avatar-lg">
                            </span>
                        <div class="mx-10">
                ...
                <div class="chat-msg self">
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <span class="msg-avatar">
                                <img src="{{ asset('/') }}public/admin/assets/images/avatar/3.jpg" class="avatar avatar-lg">
                            </span>
                    </div>
                    <div class="cm-msg-text">
